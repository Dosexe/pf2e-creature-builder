...
The download link: https://github.com/miki4920/foundryvtt-pf2e-creature-builder/releases/latest/download/module.json
...
To use the Creature Builder, you have to create a blank NPC. Using a non-blank sheet is possible, but DCs and other special abilities will not scale. 
